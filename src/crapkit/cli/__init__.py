...
_OWNER = {
    ...
    "_imports_pytest": "admin",
    "_installed_crapkit_roots": "admin",
    "_interpreter": "admin",
    "_is_rooted": "_shared",
    ...
    "_looks_like_a_path": "parser",
    "_manifest_field": "admin",
    ...
    "_missing_runner": "admin",
    "_more_skips_line": "verifying",
    "_mutation_payload": "analyses",
    "_mutation_targets": "analyses",
    "_name_found_root": "admin",
    "_name_matches": "queue",
    "_name_prefix": "queue",
    ...
    "_print_claims": "queue",
    "_print_clear_the_reason": "verifying",
