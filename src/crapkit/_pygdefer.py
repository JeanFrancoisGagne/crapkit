...
crapkit analyzes nine languages (typescript, tsx, javascript, python, swift, go,
rust, shell, powershell). Erlang is not one of them and no scope can name it. The readers that need
